...
POSE_GRAPH.constraint_builder.global_localization_min_score = 0.7 --0.58
...
POSE_GRAPH.constraint_builder.fast_correlative_scan_matcher.angular_search_window = math.rad(270.0)
  -- [1] global 전역 매칭(큰 오프셋 수정 등) 시 스캔을 추출하여 매칭 시도할 확률 (0 ~ 1). 연산량 tradeoff가 존재. 0.0036-0.004 사이. 0.0001 단위로 조절
POSE_GRAPH.global_sampling_ratio = 0.5 --0.0055 -- 정반대 일 떄
...
TRAJECTORY_BUILDER_2D.ceres_scan_matcher.occupied_space_weight = 15.0 --15.0
